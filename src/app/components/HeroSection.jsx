    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12 sm:gap-10">
        <motion.div
          ...
          className="col-span-8 place-self-center text-center sm:text-left justify-self-start sm:mb-4 mb-6"
        >
          ...
          <div>
            ...
            <Link
              href="/Ramjan_Nadaf_7248924503.pdf"
              target="_blank"
        ...
        >
          <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative  sm:w-[250px] sm:h-[250px]">
            <Image
